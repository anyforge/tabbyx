...
import { HotkeySettingsTabProvider, WindowSettingsTabProvider, VaultSettingsTabProvider, ConfigSyncSettingsTabProvider } from './settings'
...
@NgModule({
    ...
    providers: [
        ...
        // Profiles settings tab removed: connections are managed from the
        // sidebar connection tree (tabby-core ProfileTreeComponent).
